				...
				for (int z = 1; z < gridSize +1 ; z++) {
					//if (x > 0 && x < gridSize && y > 0 && y < gridSize && z > 0 && z < gridSize) {
						if(checkPositionEdges(x,y,z)) {
							cubes++;
						    //GameObject c = Builder.cubes(new Vector3((x + vx*gridSize) * 2, (y + vy*gridSize) * 2, (z+ + vz*gridSize) * 2));
							...
							Vector3 col = getColor((x + vx*gridSize) * 2, (y + vy*gridSize) * 2, (z+ + vz*gridSize) * 2);
							rend.material.SetColor("_Color", new Color(col.x, col.z, col.y));
							*/
